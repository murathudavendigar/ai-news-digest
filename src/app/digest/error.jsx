  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 bg-white dark:bg-stone-950">
      <div className="max-w-md text-center">
        <p
          className="mb-2 font-black leading-none select-none text-8xl text-stone-200 dark:text-stone-800"
        ...
        {process.env.NODE_ENV !== "production" && error?.message && (
          <div className="px-4 py-3 mb-6 text-left border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-950/30">
        ...
        <p className="mb-6 text-xs text-stone-500 dark:text-stone-600">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="px-5 py-2.5 border border-stone-300 dark:border-stone-700 text-sm font-bold text-stone-600 dark:text-stone-400 rounded-lg hover:border-stone-500 transition-colors">
            Ana Sayfa
          </Link>
        </div>
      </div>
