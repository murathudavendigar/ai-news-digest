  ...
  return (
    <section className="my-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        {/* Today — Main Card */}
        <div 
          className="col-span-1 lg:col-span-2 bg-linear-to-br from-amber-50 to-orange-50 dark:from-stone-800 dark:to-stone-900 rounded-3xl p-6 md:p-8 border border-amber-100 dark:border-stone-700 shadow-md flex flex-col justify-center transition-all"
          style={{ borderLeftWidth: 6, borderLeftColor: getColumnistAccent(todaySlug).primary }}>
          {todayCol && (
            <div className="flex items-center gap-4 mb-6">
              <div 
                className="w-14 h-14 rounded-full shrink-0 border-2 border-white dark:border-stone-800 shadow-sm flex items-center justify-center text-lg font-black text-white"
              ...
              <div>
                ...
                <div 
                  ...
                  style={{ color: getColumnistAccent(todaySlug).primary }}>
                  {todayCol.title}
                </div>
              </div>
            </div>
          ...
          {todayColumn ? (
            <div className="flex-1">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center px-5 py-2.5 text-white font-medium rounded-xl transition-all shadow-sm hover:opacity-90"
                style={{ backgroundColor: getColumnistAccent(todaySlug).primary }}>
                Yazıyı Oku →
              </Link>
            </div>
