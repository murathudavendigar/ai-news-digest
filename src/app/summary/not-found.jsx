  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 bg-stone-950">
      <div className="max-w-md text-center">
        <p
          className="text-[7rem] font-black text-stone-800 leading-none select-none"
        ...
        <Link
          href="/summary"
          className="inline-block px-6 py-3 text-sm font-bold transition-opacity rounded-lg bg-stone-100 text-stone-900 hover:opacity-90">
